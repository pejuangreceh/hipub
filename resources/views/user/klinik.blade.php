        ...
        <div class="w-full pb-10">
            <div class="w-full rounded-[10px] bg-white p-5">
                <div class="mx-auto max-w-xl text-center">
                    <h2 class="my-2 text-3xl font-extrabold tracking-tight text-dark md:text-3xl">Jadwal Aktivitas</h2>
                </div>
                <div class="mx-auto lg:w-full my-6">
                    ...
                    <div class="w-full px-6">
                        <div class="py-2 border border-l-0 border-r-0 text-center">
                            <div class="pl-1 font-semibold text-dark text-lg">Aktivitas Saya</div>
                        </div>
                        @foreach ($jadwal_user as $c)
                        <section
                                    ...
                                    <div
                                        ...
                                        <div class="col w-auto">
                                            <div class="px-4 pt-3 text-secondary text-sm">
                                                ...
                                                <span class="pl-1">{{ $c["start"] }} - {{ $c["end"] }}</span>
                                            </div>
                                        ...
                                        <div class="col w-auto pt-3 pr-5 text-right">
                                            <div class="space-y-2">
                                                <button
                                                    ...
                                                    <a href="{{$c->id.'/show_agenda'}}">Lihat Pelatihan</a>
                                                </button>
                                                <div
                                                    data-te-modal-init
